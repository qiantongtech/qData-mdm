...
package tech.qiantong.qdata.mdm.common.database.datasource;


import cn.hutool.db.ds.simple.SimpleDataSource;
import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.util.StringUtils;
import tech.qiantong.qdata.mdm.common.database.DataSourceFactory;
import tech.qiantong.qdata.mdm.common.database.DbDialect;
import tech.qiantong.qdata.mdm.common.database.DbQuery;
import tech.qiantong.qdata.mdm.common.database.DialectFactory;
...
import tech.qiantong.qdata.mdm.common.database.query.AbstractDbQueryFactory;
import tech.qiantong.qdata.mdm.common.database.query.CacheDbQueryFactoryBean;
...
public abstract class AbstractDataSourceFactory implements DataSourceFactory {
    ...
    public DataSource createDataSource(DbQueryProperty property) {
        ...
        if (DbType.SQL_SERVER2008.getDb().equals(property.getDbType()) && tech.qiantong.qdata.mdm.common.utils.StringUtils.startsWith(property.trainToJdbcUrl(), "jdbc:jtds:sqlserver")) {
